...
nkey("\\l", "Lua evaluate", ":lua =")
nkey("\\m", "Message history search", ncom("Noice telescope"))
nkey("\\n", "Next line with warning", "]w", true) -- remap?
nkey("\\o", "Select cursor pure function", "vaf")
nkey("\\p", "Paste register", tele("registers"))
