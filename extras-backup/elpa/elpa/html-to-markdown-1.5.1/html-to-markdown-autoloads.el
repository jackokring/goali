;;; html-to-markdown-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "html-to-markdown" '("htm"))

;;;***

;;;### (autoloads nil nil ("html-to-markdown-pkg.el") (0 0 0 0))
